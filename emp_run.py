...
masks = ["P1_rTP-RH", "P2_lPCC-new-LH", "P2_lPCC-new-LH", "P3_lTP-LH",
         "P4_lIFG-LH", "P5_lM1-LH", "P5_lM1-LH", "P5_lM1-LH",
...
with open(f"{root_dir}/4_emp/success_record.pickle", "wb") as f:

...
do
    simnibs_python electrode_warp_2.py -c $dir/simnibs/EEGcap_incl_cheek_buci.csv -o $dir/4/${subject}/m2m_${subject}/eeg_positions/EEGcap_incl_cheek_buci_2 -s $dir/4/${subject}/m2m_${subject}
done
cd "$orig_dir"
